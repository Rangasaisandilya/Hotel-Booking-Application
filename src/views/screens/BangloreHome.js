  ...
  const Card = ({Banglore, index}) => {
    ...
    return (
      <TouchableOpacity
        ...
        activeOpacity={1}
        onPress={() => navigation.navigate('BangloreDetails', Banglore)}>
        <Animated.View style={{...style.card, transform: [{scale}]}}>
          ...
          <Image source={Banglore.image} style={style.cardImage} />
          <View style={style.cardDetails}>
            <View
              ...
              <View>
                ...
                <Text style={{fontSize: 15}}>{Banglore.location}</Text>
              </View>
  ...
  const TopHotelCard = ({Banglore}) => {
    return (
      <View style={style.topHotelCard}>
        ...
        <Image style={style.topHotelCardImage} source={Banglore.image} />
    ...
    <SafeAreaView style={{flex: 1, backgroundColor: 'white'}}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View>
          <Animated.FlatList
            ...
            renderItem={({item, index}) => (
              <Card Banglore={item} index={index} />
            )}
        ...
        <FlatList
          ...
          renderItem={({item}) => <TopHotelCard Banglore={item} />}
        />
      </ScrollView>
    </SafeAreaView>
  );
