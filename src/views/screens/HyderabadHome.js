...
const HyderabadHome = ({navigation}) => {
  ...
  const Card = ({Hyderabad, index}) => {
    ...
    return (
      <TouchableOpacity
        ...
        activeOpacity={1}
        onPress={() => navigation.navigate('HyderabadDetails', Hyderabad)}>
        <Animated.View style={{...style.card, transform: [{scale}]}}>
          ...
          <Image source={Hyderabad.image} style={style.cardImage} />
          <View style={style.cardDetails}>
            <View
              ...
              <View>
                ...
                <Text style={{fontSize: 15}}>{Hyderabad.location}</Text>
              </View>
  ...
  const TopHotelCard = ({Hyderabad}) => {
    return (
      <View style={style.topHotelCard}>
        ...
        <Image style={style.topHotelCardImage} source={Hyderabad.image} />
    ...
    <SafeAreaView style={{flex: 1, backgroundColor: 'white'}}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View>
          <Animated.FlatList
            ...
            renderItem={({item, index}) => (
              <Card Hyderabad={item} index={index} />
            )}
        ...
        <FlatList
          ...
          renderItem={({item}) => <TopHotelCard Hyderabad={item} />}
        />
      </ScrollView>
    </SafeAreaView>
  );
